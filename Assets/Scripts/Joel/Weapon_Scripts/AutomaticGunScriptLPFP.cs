...
public class AutomaticGunScriptLPFP : MonoBehaviour
{
    ...
    private static AutomaticGunScriptLPFP instance;

    public static AutomaticGunScriptLPFP MyInstance
    {
        get
        {
            if (instance == null)
            {
                instance = FindObjectOfType<AutomaticGunScriptLPFP>();
            }
    ...
    private void Awake()
    {
        ...
        // may edite 
        // ammo = 700;
        GameObject slot = GameObject.FindWithTag("WeaponSlot5");
    ...
    private void Start()
    {
        ...
        totalAmmoText.text = AmmoCounts.MyInstance.currAssaultRifleAmmo.ToString();
    ...
    private void Update()
    {
        ...
        /*		if (true)*/
        {
            ...
            if (hunterControl.MyInstance != null)
            {
    ...
    private void Reload()
    {
        ...
        if (AmmoCounts.MyInstance.currAssaultRifleAmmo > 50)
        {
            AmmoCounts.MyInstance.currAssaultRifleAmmo = AmmoCounts.MyInstance.currAssaultRifleAmmo - 50 + currentAmmo;
            // AmmoCounts.MyInstance.pickUpAmmo((-50+currentAmmo),4);
            currentAmmo = 50;
            outOfAmmo = false;
        }
        else
        {
            if (AmmoCounts.MyInstance.currAssaultRifleAmmo > 0)
            {
                currentAmmo = AmmoCounts.MyInstance.currAssaultRifleAmmo;
                AmmoCounts.MyInstance.currAssaultRifleAmmo = 0;
                outOfAmmo = false;
            }
        }
    }
